      ...
      <div className="mx-auto max-w-sm">
        <div className="mock-frame card-sheen p-6">
          ...
          <div className="mt-6 space-y-3">
            <h2 className="font-display text-3xl leading-[1.05] text-white">
              DARKNESS
              <span className="block metallic-text text-4xl">VISUALIZER</span>
            </h2>
          ...
          <div className="mt-6 grid grid-cols-3 gap-4">
            {tintTiles.map((tile) => (
              <button
                key={tile.pct}
                className={`flex h-[92px] flex-col items-center justify-center gap-2 rounded-2xl border text-center transition-all ${
                  tile.pct === '25%'
          ...
          <div className="mt-7 overflow-hidden rounded-3xl border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.03),rgba(0,0,0,0.45))]">
            <div className="relative h-48">
              ...
              <div className="absolute left-5 top-8 text-[84px] font-extrabold leading-none text-white/20">25%</div>
